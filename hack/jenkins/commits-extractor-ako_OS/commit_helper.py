...
# Github API url for shubhamavi/load-balancer-and-ingress-services-for-kubernetes GIT repository
URL_GITHUB_AVI_DEV = URL_GITHUB + "repos/shubhamavi/load-balancer-and-ingress-services-for-kubernetes/"
