...
const (
	...
	GtwApiGatewayNameLabelKey      = "ako.vmware.com/gateway-name"
	GtwApiGatewayNamespaceLabelKey = "ako.vmware.com/gateway-namespace"
	GtwApiAviGatewayController     = "ako.vmware.com/avi-lb"
